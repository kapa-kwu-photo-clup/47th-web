    ...
    <div className="lg:w-3/4 lg:py-0 lg:px-0 px-5 mx-auto lg:mt-[4.5rem]">
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-16 text-center mt-20">
          ...
          <p className="lg:text-lg text-base lg:leading-10 leading-7">
            자연은 계절마다 <br />
            색을 바꾸며 새로운 이야기를 들려줍니다.
            <br /> 봄의 생명력 넘치는 시작, 여름의 뜨거운 열정,
            <br /> 가을의 황금빛 낭만,그리고 겨울의 순백의 세계까지.
            <br /> 이번 &lt;FOUR SEASONS&gt; 사진전은 <br />
            자연의 변화 속에서 매 순간 새롭게 펼쳐지는
            <br /> 아름다움을 담아냈습니다.
            <br /> 계절이 지닌 아름다운 이야기를 부원들의
            <br /> 작품 속에서 발견하며
          ...
          <p className="lg:text-lg text-base lg:leading-10 leading-7">
            ...
            <br /> 사계절의 변화무쌍한 아름다움과 함께 <br />각 계절을 오롯이
            담아낸 이 전시에서
            <br /> 자연이 전하는 이야기를 들어 보세요.
          </p>
